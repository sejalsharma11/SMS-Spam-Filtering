...
filepath = os.path.join(os.pardir, 'C://Users//tanma//OneDrive//Desktop//sms_spam_filtering//datasets', 'spam.csv')
...
save_path = os.path.join(
    os.pardir, 'C://Users//tanma//OneDrive//Desktop//sms_spam_filtering//results', 'trained-classifiers',
...
grid = ImageGrid(fig, rect=[0, 0, 1, 1], nrows_ncols=(2, 6), share_all=True,
...
export_folder = os.path.join(os.pardir, 'C://Users//tanma/OneDrive/Desktop//sms_spam_filtering//results', 'scores')
