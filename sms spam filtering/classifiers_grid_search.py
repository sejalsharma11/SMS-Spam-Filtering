...
import pickle
from utils import (
    get_text_vectorizer, load_dataset, logger, get_default_classifiers_grid_search
)
...
save_path = os.path.join(
    os.pardir, 'C://Users//tanma//OneDrive//Desktop//sms_spam_filtering//results', 
    'trained-classifiers', dataset_sample_type + '-dataset'
)
